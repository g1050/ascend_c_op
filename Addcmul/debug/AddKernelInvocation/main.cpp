...
int32_t main(int32_t argc, char* argv[])
{
    ...
    uint8_t* input_data = (uint8_t*)AscendC::GmAlloc(inputByteSize);
    uint8_t* value = (uint8_t*)AscendC::GmAlloc(inputByteSize);
    ...
    ICPU_RUN_KF(addcmul_custom, blockDim, input_data, x,y,value, z); // use this macro for cpu debug
    ...
    AscendC::GmFree((void *)input_data);   
