...
def gen_golden_data_simple():
    x1 = np.random.uniform(-5, 5, [8, 2048]).astype(np.int8)
    x2 = np.random.uniform(-5, 5, [8, 2048]).astype(np.int8)
    value = np.random.uniform(-5, 5, [8, 2048]).astype(np.int8)
    input_dat = np.random.uniform(-5, 5, [8, 2048]).astype(np.int8)
