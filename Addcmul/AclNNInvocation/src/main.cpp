...
OperatorDesc CreateOpDesc()
{
    ...
    opDesc.AddInputTensorDesc(dataType, shape.size(), shape.data(), format); // input_data
    opDesc.AddInputTensorDesc(dataType, shape.size(), shape.data(), format); // value
...
{
    size_t fileSize = 0;
    ReadFile("../input/input_dat.bin", fileSize, runner.GetInputBuffer<void>(0), runner.GetInputSize(0));
    ReadFile("../input/x1.bin", fileSize, runner.GetInputBuffer<void>(1), runner.GetInputSize(1));
    ReadFile("../input/x2.bin", fileSize, runner.GetInputBuffer<void>(2), runner.GetInputSize(2));
    ReadFile("../input/value.bin", fileSize, runner.GetInputBuffer<void>(3), runner.GetInputSize(3));
