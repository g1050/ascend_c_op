...
extern void sinh_custom_do(uint32_t blockDim, void* l2ctrl, void* stream, uint8_t* x, uint8_t* y);
#else
...
int32_t main(int32_t argc, char* argv[])
{
    ...
    WriteFile("./output/output_z.bin", y, outputByteSize);
    ...
    WriteFile("./output/output_z.bin", yHost, outputByteSize);
